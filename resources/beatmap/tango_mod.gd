...
static var TIMING_ACTIONS = [
	...
	[ 17.323, 'playfield', func(playfield): 
		EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.8), 0.4])
		EffectReg.start_effect(playfield, 'Bloom', [playfield.effects, 1.0, 1.0, 0.25, 99999999.0])
	...
	[ 29.494, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 29.580, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 29.666, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.3), 0.3])],
	[ 29.837, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 29.923, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 30.008, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.1), 0.3])],
	[ 30.180, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 30.266, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 30.351, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.3), 0.3])],
	[ 30.523, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 30.609, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 30.695, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.3), 0.3])],
	# 32.237 32.323 32.408 32.580 32.666 32.751 32.923 33.008 33.094 33.266 33.351 33.437
	
	[ 32.237, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 32.323, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 32.408, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.3), 0.3])],
	[ 32.580, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 32.666, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 32.751, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.3), 0.3])],
	[ 32.923, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 33.008, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 33.094, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.3), 0.3])],
	[ 33.266, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 33.351, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.15), 0.05])],
	[ 33.437, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.3), 0.3])],
	...
	[ 44.580, 'playfield', func(playfield): EffectReg.start_effect(playfield, 'Bloom', [playfield.effects, 0.0, 1.0, 0.4, 0.171])],	
	[ 44.751, 'playfield', func(playfield): 
		EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.8), 0.4])
		EffectReg.start_effect(playfield, 'Bloom', [playfield.effects, 1.0, 1.0, 0.25, 9999999.0])
	...
	[ 65.666, 'playfield', func(playfield): 
		EffectReg.start_effect(playfield, 'Flash', [playfield.effects, Color(0.98, 0.98, 0.98, 0.3), 0.3])
		EffectReg.start_effect(playfield, 'Bloom', [playfield.effects, 0.25, 1.0, 0.8, 0.342])],
