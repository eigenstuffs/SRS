...
func _input(event: InputEvent) -> void:
	...
	#if EffectReg.get_effect('ColorFade').is_running:
		#var t = EffectReg.get_effect_progress('ColorFade')
		#var start_color0 = Color(end_color.r, end_color.g, end_color.b, t)
		#EffectReg.start_effect(self, 'ColorFade', [mat_canvas, start_color0, start_color])
	#else:
	EffectReg.start_effect(self, 'ColorFade', [mat_canvas, start_color, end_color])
		
	#EffectReg.start_effect(self, 'Blur', [mat_spatial])
