...
const PITCH_LIST : SharkTankPitchList = preload("res://scenes/minigames/shark_tank/pitch_list.tres")
const DOCUMENT = preload("res://scenes/minigames/shark_tank/document.tscn")
