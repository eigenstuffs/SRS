...
const common_skin = preload("res://scenes/minigames/fishing/fish/fish_color/common_fish_text.tres")
const rare_skin = preload("res://scenes/minigames/fishing/fish/fish_color/rare_fish_text.tres")
const epic_skin = preload("res://scenes/minigames/fishing/fish/fish_color/epic_fish_text.tres")
const legendary_skin = preload("res://scenes/minigames/fishing/fish/fish_color/legendary_fish_text.tres")
