...
const FISH = preload('res://scenes/minigames/fishing/fish/fish.tscn')
@export var MAX_FISH_COUNT = 5

var active = true
var fish_array : Array[Fish] = []

@onready var FISH_STATS : FishStats = preload("res://scenes/minigames/fishing/fish/fish_stats.tres")
