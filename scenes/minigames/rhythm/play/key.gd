...
const HIT_NOTE = preload('res://scenes/minigames/rhythm/play/hit_objects/hit_note.tscn')
const HIT_SLIDER = preload('res://scenes/minigames/rhythm/play/hit_objects/hit_slider.tscn')
