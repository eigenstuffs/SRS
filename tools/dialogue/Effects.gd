...
const SFX_GLASS_BREAK = preload("res://assets/sfx/breaking_glass_1.ogg")
const SFX_PAGE_FLIP = preload("res://assets/sfx/paper_1.ogg")
const SFX_CREEPY_STINGER = preload("res://assets/sfx/creepy_stinger.ogg")
...
const SFX_AMBIANCE_HEAVY = preload("res://assets/sfx/ambiance_2.ogg")
const SFX_IMPACT_3 = preload("res://assets/sfx/impact_3.mp3")
const SFX_MELODY_SAVE = preload("res://assets/sfx/melody_1.ogg")
const SFX_DOOR_1 = preload("res://assets/sfx/door_1.mp3")
const SFX_INQUISITIVE = preload("res://assets/sfx/textbox_1.mp3")
const SFX_WHOOSH_FOAM = preload("res://assets/sfx/whoosh_1.ogg")
...
const SFX_BELLS_MYSTERY = preload("res://assets/sfx/bells_1.ogg")
const SFX_BELLS_COUNTDOWN = preload("res://assets/sfx/bells_2.ogg")
const SFX_BELLS_MAGIC_CHIME = preload("res://assets/sfx/bells_3.ogg")
...
const SFX_AMBIANCE_MORNINGBIRDS = preload("res://assets/sfx/ambiance_5.ogg")
